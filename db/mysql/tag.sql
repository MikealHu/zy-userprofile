...
-- ----------------------------------------
-- Table structure for userprofile_tag_meta
-- ----------------------------------------
DROP TABLE IF EXISTS `userprofile_tag_meta`;
create table `userprofile_tag_meta`
(
  ...
  COLLATE = utf8_bin COMMENT ='基础标签元数据表';
...
(
    ...
    `task_name` varchar(1128) COLLATE utf8_bin NOT NULL COMMENT '任务名称',
